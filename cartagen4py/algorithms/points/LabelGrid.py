# -*- coding: utf-8 -*-
"""
Created on Mon Jun 17 16:54:47 2024.
...
class LabelGrid():
    ...
    def __init__(self, points, width, height, typ='carre'):
        """
    ...
    def __createGrid(self):
        ...
        if self.__typ == 'losange':
            cols = list(np.arange(xmin-self.__width, xmax + self.__width, self.__width))
