...
`QGIS Pip Manager <https://plugins.qgis.org/plugins/pip_manager/>`_ is a plugin that makes it easier to manage Python dependencies for QGIS. Once downloaded from the QGIS plugins menu, simply follow these steps:
