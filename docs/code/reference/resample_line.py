...
sub1.set_title('Original vertices in blue, resampled line vertices in red.', pad=10, family='sans-serif')
...
for c in coords1:
    sub1.plot(c[0], c[1], linestyle="", marker='o', color="blue", markersize=20)

for c in coords2:
    sub1.plot(c[0], c[1], linestyle="", marker='o', color="red", markersize=10)
