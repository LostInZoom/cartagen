...
o1, g1 = c4.labelgrid_simplification(gdf, 5, 5, 'square', grid=True)
o2, g2 = c4.labelgrid_simplification(gdf, 5, 5, 'diamond', grid=True)
o3, g3 = c4.labelgrid_simplification(gdf, 5, 5, 'hexagonal', grid=True)
