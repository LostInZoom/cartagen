...
o1, g1 = c4.quadtree_selection(gdf, depth1, 'value', True)
o2, g2 = c4.quadtree_selection(gdf, depth2, 'value', True)
o3, g3 = c4.quadtree_selection(gdf, depth3, 'value', True)
