...
o1 = c4.kmeans_aggregation(gdf, ratio1, 'value')
o2 = c4.kmeans_aggregation(gdf, ratio2, 'value')
o3 = c4.kmeans_aggregation(gdf, ratio3, 'value')
...
for point in o1.to_dict('records'):
    ...
    sub1.plot(c[0], c[1], linestyle="", marker='o', color="red", markersize=point['cluster_count']*3)

for point in o2.to_dict('records'):
    c = point['geometry'].coords[0]
    sub2.plot(c[0], c[1], linestyle="", marker='o', color="red", markersize=point['cluster_count']*3)

for point in o3.to_dict('records'):
    c = point['geometry'].coords[0]
    sub3.plot(c[0], c[1], linestyle="", marker='o', color="red", markersize=point['cluster_count']*3)
