...
path = Path(numpy.asarray(c4.smooth_catmull_rom(line, a[0]).coords)[:, :2])
...
path = Path(numpy.asarray(c4.smooth_catmull_rom(line, a[1]).coords)[:, :2])
...
path = Path(numpy.asarray(c4.smooth_catmull_rom(line, a[2]).coords)[:, :2])
...
path = Path(numpy.asarray(c4.smooth_catmull_rom(line, a[3], 0.1).coords)[:, :2])
