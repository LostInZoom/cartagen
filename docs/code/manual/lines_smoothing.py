...
path2 = Path(numpy.asarray(c4.smooth_gaussian(line, 10, 5).coords)[:, :2])
...
path1 = Path(numpy.asarray(line.coords)[:, :2])
path2 = Path(numpy.asarray(c4.smooth_gaussian(line, 20, 5).coords)[:, :2])
...
path1 = Path(numpy.asarray(line.coords)[:, :2])
path2 = Path(numpy.asarray(c4.smooth_gaussian(line, 30, 5).coords)[:, :2])
...
path1 = Path(numpy.asarray(line.coords)[:, :2])
path2 = Path(numpy.asarray(c4.smooth_gaussian(line, 10, 30).coords)[:, :2])
...
path1 = Path(numpy.asarray(line.coords)[:, :2])
path2 = Path(numpy.asarray(c4.smooth_gaussian(line, 20, 30).coords)[:, :2])
...
path1 = Path(numpy.asarray(line.coords)[:, :2])
path2 = Path(numpy.asarray(c4.smooth_gaussian(line, 30, 30).coords)[:, :2])
...
path1 = Path(numpy.asarray(line.coords)[:, :2])
path2 = Path(numpy.asarray(c4.smooth_gaussian(line, 10, 60).coords)[:, :2])
...
path1 = Path(numpy.asarray(line.coords)[:, :2])
path2 = Path(numpy.asarray(c4.smooth_gaussian(line, 20, 60).coords)[:, :2])
...
path1 = Path(numpy.asarray(line.coords)[:, :2])
path2 = Path(numpy.asarray(c4.smooth_gaussian(line, 30, 60).coords)[:, :2])
