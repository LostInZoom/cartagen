from cartagen.algorithms.buildings.amalgamation import morphological_amalgamation, building_amalgamation
...
from cartagen.algorithms.buildings.typification import typify_buildings_matching